...
export class CommandCategory {
  public static readonly MANAGEMENT = new CommandCategory(/*CommandPermissions.BOT_OWNER,*/null, 'management', 'Bot Yönetim');
  public static readonly MODERATION = new CommandCategory(/*CommandPermissions.STAFF,*/null, 'moderation', 'Moderasyon');
  public static readonly SETTING = new CommandCategory(/*CommandPermissions.STAFF,*/null, 'setting', 'Ayar');
